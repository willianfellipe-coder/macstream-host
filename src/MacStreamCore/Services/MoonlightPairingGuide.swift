...
public final class DefaultMoonlightPairingGuide: MoonlightPairingGuiding {
    ...
    public func pairingSteps() -> [PairingStep] {
        [
            PairingStep(id: 1, title: "Abra a Web UI do Sunshine", detail: "Use o botão do app para abrir https://localhost:47990 e mantenha o Sunshine rodando."),
            ...
            PairingStep(id: 4, title: "Confirme o PIN", detail: "Digite na Web UI do Sunshine o PIN exibido pelo Moonlight."),
