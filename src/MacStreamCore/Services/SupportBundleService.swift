...
public final class DefaultSupportBundleService: SupportBundleServicing {
    ...
    private func summary(for diagnostics: DiagnosticsReport) -> String {
        ...
        var lines = [
            ...
            "MacStream Agent: \(diagnostics.agentStatus.isRunning ? "running" : diagnostics.agentStatus.launchAgentStatus.displayName)",
            "Remote Work Mode: \(diagnostics.remoteWorkSession.state.displayName)",
            "Power: \(diagnostics.remoteWorkSession.powerStatus.detail)",
            "Host privacy: \(diagnostics.remoteWorkSession.hostPrivacyStatus.detail)",
